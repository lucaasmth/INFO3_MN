...
int main (int argc, char **argv)
{
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_nano ("sswap nano ", 2 * VECSIZE, end_nano-start_nano) ;
	}
	printf ("==========================================================\n") ;
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_nano ("dswap nano ", 2 * VECSIZE, end_nano-start_nano) ;
	}
	printf ("==========================================================\n") ;
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_nano ("cswap nano ", 2 * VECSIZE, end_nano-start_nano) ;
	}
	printf ("==========================================================\n") ;
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_nano ("zswap nano ", 2 * VECSIZE, end_nano-start_nano) ;
	}
	printf ("==========================================================\n") ;
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_micro ("sswap micro", 2 * VECSIZE, tdiff_micro (&start, &end)) ;
	}
 	printf ("==========================================================\n") ;
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_micro ("dswap micro", 2 * VECSIZE, tdiff_micro (&start, &end)) ;
	}
 	printf ("==========================================================\n") ;
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_micro ("cswap micro", 2 * VECSIZE, tdiff_micro (&start, &end)) ;
	}
 	printf ("==========================================================\n") ;
	...
	for (int i = 0 ; i < NB_FOIS; i++) {
		...
		calcul_flop_micro ("zswap micro", 2 * VECSIZE, tdiff_micro (&start, &end)) ;
	}
 	printf ("==========================================================\n") ;
}

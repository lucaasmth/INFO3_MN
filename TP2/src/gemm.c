...
void mncblas_dgemm(MNCBLAS_LAYOUT layout, MNCBLAS_TRANSPOSE TransA, MNCBLAS_TRANSPOSE TransB, const int M, const int N,
...
void mncblas_cgemm(MNCBLAS_LAYOUT layout, MNCBLAS_TRANSPOSE TransA, MNCBLAS_TRANSPOSE TransB, const int M, const int N,
                   const int K, const void *alpha, const void *A, const int lda, const void *B, const int ldb,
...
#pragma omp parallel for
                for (int i = 0; i < M; i++) {
                    for (int j = 0; j < N; j++) {
                        ...
                        somme.imaginary = 0;
                        for (int k = 0; k < K; k++) {
                            somme = add_complexe_double(somme,
                                                        mult_complexe_double(((complexe_double_t *) A)[i * lda + k],
                                                                             ((complexe_double_t *) B)[k * ldb + j]));
                        }
                        ((complexe_double_t *) C)[i * ldc + j].real = ((complexe_float_t *) alpha)->real * somme.real +
                                                                      ((complexe_float_t *) alpha)->imaginary *
                                                                      somme.imaginary +
                                                                      ((complexe_float_t *) beta)->real *
                                                                      ((complexe_double_t *) C)[i * ldc + j].real -
                                                                      ((complexe_float_t *) beta)->imaginary *
                                                                      ((complexe_double_t *) C)[i * ldc + j].imaginary;
                        ((complexe_double_t *) C)[i * ldc + j].imaginary =
                                ((complexe_float_t *) alpha)->real * somme.imaginary +
                                ((complexe_float_t *) alpha)->imaginary * somme.real +
                                ((complexe_float_t *) beta)->real * ((complexe_double_t *) C)[i * ldc + j].imaginary +
                                ((complexe_float_t *) beta)->imaginary * ((complexe_double_t *) C)[i * ldc + j].real;
                    }
                }
...
#pragma omp parallel for
                for (int i = 0; i < M; i++) {
                    for (int j = 0; j < N; j++) {
                        ...
                        for (int k = 0; k < K; k++) {
                            somme = add_complexe_double(somme,
                                                        mult_complexe_double(((complexe_double_t *) A)[k * lda + i],
                                                                             ((complexe_double_t *) B)[k * ldb + j]));
                        }
                        ((complexe_double_t *) C)[i * ldc + j].real = ((complexe_float_t *) alpha)->real * somme.real +
                                                                      ((complexe_float_t *) alpha)->imaginary *
...
void mncblas_zgemm(MNCBLAS_LAYOUT layout, MNCBLAS_TRANSPOSE TransA, MNCBLAS_TRANSPOSE TransB, const int M, const int N,
                   const int K, const void *alpha, const void *A, const int lda, const void *B, const int ldb,
                   const void *beta, void *C, const int ldc) {
    if (layout == MNCblasRowMajor) {
        if (TransA == MNCblasNoTrans) {
...
#pragma omp parallel for
                for (int i = 0; i < M; i++) {
                    for (int j = 0; j < N; j++) {
                        ...
                        somme.imaginary = 0;
                        for (int k = 0; k < K; k++) {
                            somme = add_complexe_float(somme, mult_complexe_float(((complexe_float_t *) A)[i * lda + k],
                                                                                  ((complexe_float_t *) B)[k * ldb +
                                                                                                           j]));
                        }
                        ((complexe_float_t *) C)[i * ldc + j].real = ((complexe_float_t *) alpha)->real * somme.real +
                                                                     ((complexe_float_t *) alpha)->imaginary *
                                                                     somme.imaginary +
                                                                     ((complexe_float_t *) beta)->real *
                                                                     ((complexe_float_t *) C)[i * ldc + j].real -
                                                                     ((complexe_float_t *) beta)->imaginary *
                                                                     ((complexe_float_t *) C)[i * ldc + j].imaginary;
                        ((complexe_float_t *) C)[i * ldc + j].imaginary =
                                ((complexe_float_t *) alpha)->real * somme.imaginary +
                                ((complexe_float_t *) alpha)->imaginary * somme.real +
                                ((complexe_float_t *) beta)->real * ((complexe_float_t *) C)[i * ldc + j].imaginary +
                                ((complexe_float_t *) beta)->imaginary * ((complexe_float_t *) C)[i * ldc + j].real;
                    }
                }
            } else if (TransB == MNCblasTrans) {
                complexe_float_t somme;
...
#pragma omp parallel for
                for (int i = 0; i < M; i++) {
                    for (int j = 0; j < N; j++) {
                        ...
                        somme.imaginary = 0;
                        for (int k = 0; k < K; k++) {
                            somme = add_complexe_float(somme, mult_complexe_float(((complexe_float_t *) A)[k * lda + i],
                                                                                  ((complexe_float_t *) B)[k * ldb +
                                                                                                           j]));
                        }
                        ((complexe_float_t *) C)[i * ldc + j].real = ((complexe_float_t *) alpha)->real * somme.real +
